...
class audience_resulting_zero_results(tests.SeleniumTest):
    ...
    def test_error_message_at_history_panel(self):
        ...
        message = tag[0].text
        self.assertEqual(message, "There are no people that match this criteria. Please re-visit criteria selections and try again.", "Incorrect message is getting displayed at History Panel")
    ...
    def test_error_message_at_viz_canvas(self):
        ...
        self.assertEqual(message, "There are no people that match this criteria. Please review and try building again. You can also reference our Audience Explorer FAQs.", "Incorrect message is getting displayed at Viz Canvas")
    ...
    def test_compare_icon_disabled_for_audience_resultingin_zero_results(self):
        ...
        try:
            ...
            print("There are no people that match this criteria Please review and try building again.So, Audience checkbox is disabled")
